...
// Le middleware d'auto-reconnect Neon est appliqué ici — c'est basePrisma qui gère la connexion réelle.
...
// NOTE : l'extension Prisma ne crée pas de nouvelle connexion — le middleware reconnect
// sur basePrisma couvre donc également toutes les requêtes passant par prisma.
