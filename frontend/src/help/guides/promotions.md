...
Le module **Promotions** vous permet de créer des offres tarifaires spéciales pour fidéliser vos clients et animer votre activité.
...
- Dans **Promotions > Coupons**, cliquez sur **Nouveau coupon**.
- Saisissez un **code** personnalisé (ex. BIENVENUE10) ou laissez Restoflow en générer un aléatoirement.
- Choisissez le type de réduction : **pourcentage** ou **montant fixe**.
- Paramétrez les restrictions optionnelles :
  - **Date d'expiration** — le coupon n'est plus accepté après cette date.
  - **Nombre d'utilisations maximum** — utile pour les offres limitées.
  - **Montant minimum de commande** — le coupon ne s'applique qu'au-dessus d'un seuil.
- Activez ou désactivez le coupon à tout moment.
